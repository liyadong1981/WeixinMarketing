...
namespace Senparc.Mvc
{
    ...
    {
        public static ValidatorContainer<T> Validator<T>(this Controller controller, T validatorObject, string valueName,
            string htmlName)
        {
        ...
        /// <returns></returns>
        public static ValidatorContainer<T> Validator<T>(this Controller controller, T validatorObject, string valueName,
            string htmlName, bool? nullOrEmptyable = null)
        {
            ...
            if (nullOrEmptyable != null &&
                (validatorObject == null || string.IsNullOrEmpty(validatorObject.ToString().Trim())))
            {
        ...
        public static ValidatorContainer<T> IsTrue<T>(this ValidatorContainer<T> container, Func<T, bool> func,
            string failMessageFormat, bool stopWhileFail)
        {
            if (container == null)
            {
                return null;
        ...
        public static ValidatorContainer<T> IsFalse<T>(this ValidatorContainer<T> container, Func<T, bool> func,
            string failMessageFormat, bool stopWhileFail)
        {
            if (container == null)
            {
        ...
        /// <returns></returns>
        public static ValidatorContainer<T> Fail<T>(this ValidatorContainer<T> container, string failMessageFormat,
            bool stopWhileFail)
        {
            if (container == null)
            {
        ...
        public static ValidatorContainer<T> Regex<T>(this ValidatorContainer<T> container, string expression,
            string failMessageFormat, bool stopWhileFail)
        {
            if (container == null)
            {
            ...
            Regex emailExpression = new Regex(expression,
        ...
        public static ValidatorContainer<T> IsSafeSqlString<T>(this ValidatorContainer<T> container, bool stopWhileFail)
        {
            ...
            Regex emailExpression = new Regex(@"[-|;|,|\/|\(|\)|\[|\]|\}|\{|%|@|\*|!|\']",
                RegexOptions.Compiled | RegexOptions.Singleline | RegexOptions.IgnoreCase);
            if (emailExpression.IsMatch((container.ValidatorObject.ToString())))
            {
        ...
        /// <param name="stopWhileFail"></param>
        /// <returns></returns>
        public static ValidatorContainer<T> IsSafeUserInfoString<T>(this ValidatorContainer<T> container,
            bool stopWhileFail)
        {
            if (container == null)
            {
        ...
        public static ValidatorContainer<T> IsValidateUserInfoName<T>(this ValidatorContainer<T> container,
            bool stopWhileFail)
        {
            if (container == null)
            {
            ...
            bool stopWhileFail)
        {
            ...
            {
                string errorMessage = string.Format("{0}中最多只能输入{1}字节的内容（对应{2}汉字）", container.ValueName, maxByte,
                    Convert.ToInt32(maxByte/2));
                container.AddError(errorMessage);
                if (stopWhileFail)
                {
                    return null;
            ...
            bool stopWhileFail)
        {
            ...
            {
                string errorMessage = string.Format("{0}中至少需要入{1}字节的内容（对应{2}汉字）", container.ValueName, minByte,
                    Convert.ToInt32(minByte/2));
                container.AddError(errorMessage);
                if (stopWhileFail)
                {
                    return null;
        ...
        public static ValidatorContainer<T> IsEqual<T>(this ValidatorContainer<T> container, T obj,
            string failMessageFormat, bool stopWhileFail)
        {
            if (container == null)
            {
        ...
        public static ValidatorContainer<T> IsNotEqual<T>(this ValidatorContainer<T> container, T obj,
            string failMessageFormat, bool stopWhileFail)
        {
            if (container == null)
            {
        ...
        public static ValidatorContainer<T> IsNumber<T>(this ValidatorContainer<T> container, float? min, float? max,
            bool stopWhileFail)
        {
            if (container == null)
            {
            ...
            float tryFloat;
            if (!float.TryParse(container.ValidatorObject.ToString(), out tryFloat) || tryFloat < (float) min ||
                tryFloat > (float) max)
            {
        ...
        public static ValidatorContainer<T> IsNull<T>(this ValidatorContainer<T> container, object obj,
            string failMessageFormat, bool stopWhileFail)
        {
            if (container == null)
            {
        ...
        public static ValidatorContainer<T> IsNotNull<T>(this ValidatorContainer<T> container, object obj,
            string failMessageFormat, bool stopWhileFail)
        {
            if (container == null)
            {
