(function (factory) {
    ...
    var createVideoNode = function (url) {
        ...
        var qqRegExp = /\/\/v\.qq\.com\/cover\/(\w+)\/(\w+).html[?]vid=(\w+)/;
        ...
        var $video;
        if (qqMatch && qqMatch[3].length) {
            $video = $('<iframe class="video_iframe" style=" z-index:1; " allowfullscreen="">')
              .attr('frameborder', 0)
              .attr('height', '200')
              .attr('width', '100%')
              .attr('src', 'http://v.qq.com/iframe/player.html?vid=' + qqMatch[3] + '&amp;auto=0');
        }
        ...
        langs: {
            ...
            'zh-CN': {
                video: {
                    ...
                    insert: '插入视频',
                    url: '视频地址',
                    providers: '(腾讯视频, 优酷, Instagram, DailyMotion, Youtube等)'
                }
            },
            'zh-TW': {
                video: {
